...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.prevButton.setGeometry(QRect(-1, -1, 52, 25))
        self.prevButton.setObjectName("prevButton")
        self.homeButton = QPushButton(self.centralwidget)
        self.homeButton.setGeometry(QRect(49, -1, 52, 25))
        self.homeButton.setObjectName("homeButton")
        self.nextButton = QPushButton(self.centralwidget)
        self.nextButton.setGeometry(QRect(99, -1, 52, 25))
        self.nextButton.setObjectName("nextButton")
        self.urlEdit = QLineEdit(self.centralwidget)
        self.urlEdit.setGeometry(QRect(150, 0, 250, 23))
        self.urlEdit.setObjectName("urlEdit")
        self.goButton = QPushButton(self.centralwidget)
        self.goButton.setGeometry(QRect(399, -1, 52, 25))
        self.goButton.setObjectName("goButton")
        self.comboBox = QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QRect(0, 525, 200, 22))
        self.comboBox.setObjectName("comboBox")
        self.pathEdit = QLineEdit(self.centralwidget)
        self.pathEdit.setGeometry(QRect(200, 525, 270, 22))
        self.pathEdit.setReadOnly(True)
        self.pathEdit.setObjectName("pathEdit")
        self.toolButton = QToolButton(self.centralwidget)
        self.toolButton.setGeometry(QRect(469, 524, 32, 24))
        self.toolButton.setObjectName("toolButton")
        self.downButton = QPushButton(self.centralwidget)
        self.downButton.setGeometry(QRect(449, -1, 52, 25))
        self.downButton.setObjectName("downButton")
        self.downAllButton = QPushButton(self.centralwidget)
        self.downAllButton.setGeometry(QRect(499, -1, 52, 25))
        self.downAllButton.setObjectName("downAllButton")
        self.listWidget = QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QRect(0, 546, 551, 134))
